...
2025-11-20 - Favicony i weryfikacja Yandex
- Co zrobiłam: Przygotowałam zestaw favicon (SVG + PNG 32px i 192px) i podpięłam je w projekcie /piespatron/ oraz w repozytorium root (oneofhersisters.github.io), żeby favicon pojawiał się także dla adresu bez podkatalogu. Dodałam w head odpowiednie `<link rel="icon">` i `apple-touch-icon`. Do obu repozytoriów wrzuciłam plik weryfikacyjny Yandex (`yandex_0b1007f49f9fbfcf.html`), dzięki czemu mogę potwierdzić własność zarówno dla /piespatron/, jak i dla domeny głównej. Bing zgłaszał dwa znaczniki H1, więc zmieniłam nagłówek w menu na `<p class="sitename">`, zostawiając jednego H1 w hero.
- Co się zmieniło: Teraz Google może pokazywać faviconę w wynikach (również w widoku mobilnym), a root strony już nie ma „gołego” favicona. Yandex Webmaster rozpoznaje plik weryfikacyjny, więc mogę potwierdzić prawa do całej domeny i zgłosić sitemap. Strona spełnia wymóg jednego H1, więc Bing nie raportuje ostrzeżenia. Największy sukces: dla zapytania „пес патрон портфолио” moja strona pojawia się jako pierwszy wynik w wyszukiwarce Yandex.
- Moje wnioski: Warto utrzymywać spójne favicony w obu repo, bo Google/Yandex traktują adresy osobno. Pliki weryfikacyjne najlepiej trzymać w obu katalogach, żeby szybciej przechodzić walidacje. Kontrola HTML (np. liczba H1) ma realny wpływ na raporty Bing Webmaster Tools. Widzę też, że nawet przy małym projekcie da się osiągnąć 1. miejsce w Yandex na frazę „пес патрон портфолио”, jeśli zadba się o techniczne SEO, treść i poprawne zgłoszenie strony w narzędziach dla webmasterów.
